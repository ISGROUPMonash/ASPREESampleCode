...
Search.participantSearchMongo = function (formid, formType) {
    ...
    if (formType === 1) {
        ...
        sendData.FormTitle = $("#frm_ParticipantRegistration").val();
        callApi = true;
    }
        ...
        sendData.ProjectId = $('#ProjectId').val();
        sendData.FormId = formid;
        sendData.FormTitle = $("#frm_PersonRegistration").val();
        callApi = true;
    }
    else if (formType === 3) {
        if (!Search.validateSearchForm(formType)) {
        ...
        sendData.ProjectId = $('#ProjectId').val();
        sendData.FormId = formid;
        sendData.FormTitle = $("#frm_PlaceGroupRegistration").val();
        callApi = true;
    }
    else if (formType === 4) {
        if (!Search.validateSearchForm(formType)) {
        ...
        sendData.ProjectId = $('#ProjectId').val();
        sendData.FormId = formid;
        sendData.FormTitle = $("#frm_ProjectRegistration").val();
        callApi = true;
    }
    if (callApi === true) {
        let url = '/Search/SearchEntities';

        if (App.IsTestSite === true) {
            url = 'Review/SearchEntities_M';
        }
                ...
                if (formType == 1) {
                            ...
                            if (c === "") {
                                ...
                                jQuery.each(frm, function (i, val) {
                                    if (val.variableName == "EntID") {
                                        ...
                                        entId = "<tr><td class='sf-hd-title'>Participant ID:</td><td>" + App.ConvertInto7Digit(val.selectedValues) + "</td></tr>";
                    ...
                    if (result.length > 1) {
                        ...
                        jQuery.each(result, function (i, frm) {
                            ...
                            jQuery.each(frm, function (i, val) {
                                if (val.variableName == "EntID") {
                                    entId = App.ConvertInto7Digit(val.selectedValues);
                                }
                                if (val.variableName == "FirstName") {
                        ...
                        jQuery.each(result, function (i, frm) {
                            ...
                            jQuery.each(frm, function (i, val) {
                                if (val.variableName == "EntID") {
                                    entId = "<tr><td class='sf-hd-title'>Person ID:</td><td>" + App.ConvertInto7Digit(val.selectedValues) + "</td></tr>";
                                    searchUserId = val.selectedValues;
                    ...
                    if (result.length > 1) {
                        ...
                        jQuery.each(result, function (i, frm) {
                            ...
                            jQuery.each(frm, function (i, val) {
                                if (val.variableName == "EntID") {
                                    searchUserId = val.selectedValues;
                                    entId = "<tr><td class='sf-hd-title'>Place ID:</td><td>" + App.ConvertInto7Digit(val.selectedValues) + "</td></tr>";
                                }
                                if (val.variableName == "Name") {
                                ...
                                if (val.variableName == "State") {
                                    if (val.selectedValues !== "") {
                                        //let sname = Search.StateList.find(x => x.guid === val.selectedValues).name;
                                        var sname = Search.StateList.find(function (x) {
                                            return x.guid === val.selectedValues;
                                        }).name;
                                        val.selectedValues = sname;
                    ...
                    if (result.length > 1) {
                        ...
                        jQuery.each(result, function (i, frm) {
                            ...
                            jQuery.each(frm, function (i, val) {
                                ...
                                if (val.variableName == "EntID") {
                                    searchUserId = val.selectedValues;
                                    entId = "<tr><td class='sf-hd-title'>Project ID:</td><td>" + App.ConvertInto7Digit(val.selectedValues) + "</td></tr>";
                                }
                                if (val.variableName == "Name") {
...
Search.save = function () {
    ...
    if (gFormType === 1) {
        ...
        sendData.ActivityId = $("#act_ParticipantRegistration").val();
    }
        ...
        sendData.ActivityId = $("#act_PersonRegistration").val();
    }
        ...
        sendData.ActivityId = $("#act_PlaceGroupRegistration").val();
    }
        ...
        sendData.ActivityId = $("#act_ProjectRegistration").val();
    }
    if (callApi === true) {
      

        let url = 'Search/SaveEntities/';
        if (App.IsTestSite === true) {
            url = 'Review/SaveEntities/';
        }
        App.postData(App.ApiUrl + url, sendData, function (result) {
